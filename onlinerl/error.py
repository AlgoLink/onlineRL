"""Set of Error classes for onlinerl."""
import warnings
...
class APIError(Error):
    """Deprecated, to be removed at onlinerl 1.0."""
    ...
    def __init__(
        ...
        warnings.warn("APIError is deprecated and will be removed at onlinerl 1.0")
...
class CustomSpaceError(Exception):
    """The space is a custom onlinerl.Space instance, and is not supported by `AsyncVectorEnv` with `shared_memory=True`."""
